...
<div class="back">
	...
	<div class="w-full lg:w-2/5">
		...
		<img src="@/assets/img/lala.jpg" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
...
<style>
.back{
  background-image: url('~assets/img/fir.jpg');
}
